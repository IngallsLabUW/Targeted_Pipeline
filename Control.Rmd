...
if (length(dir(path = "data_processed/")) == 0) {
  print("Data_processed subdirectory is ready for new data.")
} else {
  print("Warning: data_processed subdirectory is not empty. Empty contents before continuing.")
}
```
...
"data_intermediate/QuickReport_*file.pattern*_*DATE*.txt"
...
```{r Quantify imports, include=FALSE}
...
if (check.duplicates == 0) {
  ...
  print("Filtering out chosen duplicates.")
