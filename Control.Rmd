...
Area.positive <- Area_HILICPos_EddyTransect
Mz.positive   <- Mz_HILICPos_EddyTransect
RT.positive   <- RT_HILICPos_EddyTransect
SN.positive   <- SN_HILICPos_EddyTransect

Area.negative <- Area_HILICNeg_EddyTransect
Mz.negative   <- Mz_HILICNeg_EddyTransect
RT.negative   <- RT_HILICNeg_EddyTransect
SN.negative   <- SN_HILICNeg_EddyTransect
